...
function Cell({ col, data, selected, border }) {
    ...
    return <div
        ...
        <div className="name">{name(data.id)}</div><br />
...
function Empty({ border, overlay }) {
    const b = border ? <div className='border'></div> : <></>
    const o = overlay ? <div className="overlay"><div className="text">No Components</div></div> : <></>
